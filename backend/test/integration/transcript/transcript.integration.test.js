...
describe('Transcript (integration)', () => {
    ...
    it('should get Transcript by callSid', async () => {
        ...
        const res = await (0, supertest_1.default)(app.getHttpServer()).get(`/calllogs/${calllogId}/transcript`);
    ...
    it('should return 404 for non-existent Transcript', async () => {
        ...
        const res = await (0, supertest_1.default)(app.getHttpServer()).get(`/calllogs/${nonExistentId}/transcript`);
    ...
    it('should delete the Transcript', async () => {
        ...
        const res = await (0, supertest_1.default)(app.getHttpServer()).delete(`/calllogs/${calllogId}/transcript`);
        expect(res.status).toBe(200);
        expect(res.body.callSid).toBe(callSid);
    });
...
//# sourceMappingURL=transcript.integration.test.js.map