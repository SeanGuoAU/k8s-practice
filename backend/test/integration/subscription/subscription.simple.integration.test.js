...
describe('SubscriptionController (Simple Integration)', () => {
    ...
    it('should create a new subscription with valid data', async () => {
        ...
        const planResponse = await (0, supertest_1.default)(app.getHttpServer())
            .post('/plan')
            .send(testPlan)
            .timeout(5000);
        ...
        // Create subscription
        const testSubscription = (0, subscription_1.createMockSubscriptionDto)({
            userId: testUserId,
            planId: planId,
        });
    ...
    it('should return 404 for non-existent user subscription', async () => {
        const nonExistentUserId = new mongoose_1.default.Types.ObjectId().toString();
        const response = await (0, supertest_1.default)(app.getHttpServer())
...
//# sourceMappingURL=subscription.simple.integration.test.js.map